        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <x-nav-link 
                href="/home"
                :active="request()->is('home')">Home
              </x-nav-link>
               <x-nav-link 
                href="/profil"
                :active="request()->is('profil')">Profil
              </x-nav-link>
              <x-nav-link 
                href="/kontak"
              ...
              <x-nav-link 
                href="/students"
                :active="request()->is('students')">Students
              </x-nav-link>
              <x-nav-link 
                href="/guardians"
                :active="request()->is('guardians')">Guardians
              </x-nav-link>
              <x-nav-link 
                href="/classrooms"
                :active="request()->is('classrooms')">Classrooms
              </x-nav-link>
              <x-nav-link 
                href="/teachers"
               :active="request()->is('teachers')">Teacher
              </x-nav-link>
              <x-nav-link 
                  href="/subjects"
                  :active="request()->is('subjects')">Subject
              </x-nav-link>
