    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div x-data="{ 
                ...
                <!-- Edit Modal -->
                <div x-if="editingStudent" x-cloak>
                        ...
                        <div @click.outside="openEditModal = false"
                            ...
                            <form :action="`{{ route('students.update', 'ID') }}`.replace('ID', editingStudent.id)" method="POST" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="edit_name" name="name" x-model="editingStudent.name" required class="w-full border rounded p-2">
                                </div>

                                <div>
                                    <label for="edit_classroom">Classroom</label>
                                    <select id="edit_classroom" name="classroom_id" x-model="editingStudent.classroom_id" required class="w-full border rounded p-2">
                                ...
                                <div>
                                    ...
                                    <input type="email" id="edit_email" name="email" x-model="editingStudent.email" required class="w-full border rounded p-2">
                                </div>

                                <div>
                                    <label for="edit_address">Address</label>
                                    <input type="text" id="edit_address" name="address" x-model="editingStudent.address" class="w-full border rounded p-2">
                                </div>
                ...
                <div x-show="openDeleteModal" x-transition.opacity x-cloak
                    ...
                    <div @click.outside="openDeleteModal = false"
                        ...
                        <p class="mb-4 text-gray-600 dark:text-gray-300">Are you sure you want to delete this student?</p>
